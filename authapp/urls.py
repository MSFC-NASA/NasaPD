...
urlpatterns = [
    ...
    # path('bargraph/', BargraphView.as_view(template_name="authapp/display_bar_graph.html"), name='bargraph'),
    # path('linegraph/', LinegraphView.as_view(template_name="authapp/display_line_graph.html"), name='linegraph'),
